...
def sample_pose(obj: bproc.types.MeshObject):
    ...
    obj.set_scale([1, 1, 1])
    obj.set_location(np.random.uniform([-0.0015, -0.0015, 0.008], [0.0015, 0.0015, 0.008]))
...
poi = bproc.object.compute_poi(obj_queue) + np.random.uniform([-0.006, -0.006, 0], [0.006, 0.006, 0])
